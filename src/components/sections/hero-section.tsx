...
export function HeroSection({ config }: { config: SiteConfig }) {
  return (
    <section
      id="home"
      className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center gap-5 overflow-hidden px-6 py-16 text-center"
    >
      {/* Gold bars — signature diagonal motif */}
      <div className="absolute right-[150px] -bottom-[5%] w-[90px] h-[55%] bg-gold-500/20 -rotate-[32deg] rounded-[6px] pointer-events-none z-0" />
      <div className="absolute right-5 -bottom-[10%] w-[80px] h-[55%] bg-gold-500/14 -rotate-[32deg] rounded-[6px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 flex flex-col gap-2 mt-1 max-w-[520px]">
        ...
        <p className="text-sm leading-relaxed text-white/60">{config.team.description}</p>
        <p className="text-sm leading-relaxed text-white/60">
          Whether you&apos;re looking for a squad to run games with or create content for fun — you&apos;re in the
          right place.
        </p>
      </div>
